...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
    ...
    return {
        ...
        alternates: {
            canonical: `https://www.metodokakebo.com${locale === 'es' ? '' : `/${locale}`}/cookies`,
            languages: {
                "es": "https://www.metodokakebo.com/cookies",
                "en": "https://www.metodokakebo.com/en/cookies",
                "x-default": "https://www.metodokakebo.com/cookies"
            }
        },
    };
}
